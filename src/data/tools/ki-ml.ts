...
export const kiMlTools: Tool[] = [
  ...
  },
  {
    ...
    name: 'CricketBrain',
    slug: 'cricket-brain',
    tagline: 'Neuromorphe Muster­erkennung nach Vorbild des Grillen-Gehörs',
    taglineEn: 'Neuromorphic pattern recognition inspired by cricket hearing',
    description:
      'CricketBrain ist eine biomorphe Inference-Engine in Rust, die zeitliche Muster per Delay-Line-Koinzidenzerkennung verarbeitet – ganz ohne Matrixmultiplikation oder GPU. Inspiriert vom auditiven System der Feldgrille erreicht sie in Tests TPR=1,0 und FPR=0,0 über alle getesteten SNR-Stufen. Der Kern ist no_std-fähig und damit für Embedded-Geräte nutzbar. Sprachbindings existieren für Rust, C/C++, Python und WebAssembly.',
    descriptionEn:
    ...
    website: 'https://github.com/BEKO2210/cricket-brain',
    github: 'https://github.com/BEKO2210/cricket-brain',
    license: 'AGPL-3.0',
    categories: ['ki-ml'],
    replacesTools: ['TensorFlow Lite', 'PyTorch Mobile'],
    selfHostable: true,
    logoPlaceholderEmoji: '🦗',
    logoUrl: 'https://avatars.githubusercontent.com/u/BEKO2210.png?size=128',
    stars: 1,
    lastUpdated: '2026-07-27',
    tags: ['neuromorphic', 'rust', 'embedded', 'no-std', 'signal-processing', 'stdp', 'spiking-neural-network'],
    difficulty: 'fortgeschritten',
    platforms: ['linux', 'windows', 'macos'],
    featured: false,
    addedDate: '2026-04-17',
