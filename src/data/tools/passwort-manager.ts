...
export const passwortManagerTools: Tool[] = [
  ...
  },
  {
    ...
    description:
      'Authier ist ein in Tschechien entwickelter, quelloffener Passwort-Manager mit Browser-Autofill, clientseitig verschluesselter Vault-Synchronisation und integriertem TOTP. Die aktuellen Downloads sind Erweiterungen fuer Chrome, Firefox und Edge; auf Android wird Firefox unterstuetzt, eine gepflegte native Mobil-App gibt es derzeit nicht. Neue Browser werden ueber einen bereits genehmigten Geraete-Workflow aufgenommen. Der gesamte Stack liegt in einem oeffentlichen AGPL-Monorepo.',
    descriptionEn:
      'Authier is an open-source password manager developed in Czechia, with browser autofill, client-side encrypted vault sync, and built-in TOTP. Current downloads are extensions for Chrome, Firefox, and Edge; Android support is through Firefox, and there is no maintained native mobile app. New browsers enroll through an already approved trusted-device workflow. The full stack lives in one public AGPL monorepo.',
    ...
    replacesTools: ['LastPass', '1Password'],
    selfHostable: false,
    hostedService: 'https://www.authier.pm/pricing',
    logoPlaceholderEmoji: '🛡️',
    stars: 14,
